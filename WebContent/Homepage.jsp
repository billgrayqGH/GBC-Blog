...
<ul class="w3-navbar w3-black w3-hide-small">
 ...
 <li><a href="Register.jsp"><i class="fa fa-address-card"></i>&nbsp REGISTER</a></li>
</ul>
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          ...
          <p class="w3-right"><button class="w3-btn" onclick="myFunction('demo1')" id="myBtn"><b> Log In to Comment  </b> <span class="w3-tag w3-white"></span></button></p>
          <p class="w3-clear"></p>
            <hr>
